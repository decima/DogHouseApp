...
test("test valeur negative", 1, function()
{
	throws(function() {new money(-1,"EUR")}, ValeurNegativeExc, "Valeur Negative");
}
);

test("test devise trop longue", 1, function()
{
	throws(function() {new money(10,"EUROPE")}, DeviseTropLongueExc, "Devise Trop Longue");
}
);
