...
window.onload = function () {
    var r = new drivers.Route();
    r.assignRoute("/next", function () {
        console.log("next path!");
    });
    r.assignRoute("/calendrier/{date}", function (date) {
        //afficher calendrier pour la date
        console.log(date);
    });
    r.assignRoute("/calendrier/{date}/addEvent", function (date) {
        //afficher calendrier pour la date
        console.log(date);
    });
    r.proceed();
    r.enableProceedEvent();
